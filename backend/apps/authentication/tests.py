...
class RegistrationTestCase(TestCase):
    ...
    def test_successful_startup_registration(self):
        ...
        self.assertTrue(hasattr(user, 'startup_profile'))
        self.assertEqual(user.startup_profile.company_name, 'Test name')

        self.assertEqual(len(mail.outbox), 1)
        self.assertIn('Verify', mail.outbox[0].subject)
        self.assertIn('startup@example.com', mail.outbox[0].to)
    ...
    def test_successful_investor_registration(self):
        ...
        self.assertTrue(hasattr(user, 'investor_profile'))
        self.assertEqual(user.investor_profile.investment_range_min, 10000)
